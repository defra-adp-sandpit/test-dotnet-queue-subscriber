...
using Test.Dotnet.Queue.Subscriber.Api.Extensions;
using Test.Dotnet.Queue.Subscriber.Api.HealthChecks;
...
namespace Test.Dotnet.Queue.Subscriber.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Test.Dotnet.Queue.Subscriber", Version = "v1" });
        });
